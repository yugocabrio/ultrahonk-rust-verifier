...
abstract contract BaseHonkVerifier is IVerifier {
    ...
    function verify(bytes calldata proof, bytes32[] calldata publicInputs) public view override returns (bool) {
        ...
        // Log transcript parameters
        console2.log("=== TRANSCRIPT PARAMETERS ===");
        console2.log("eta:");
        console2.logBytes32(bytes32(Fr.unwrap(t.relationParameters.eta)));
        console2.log("eta_two:");
        console2.logBytes32(bytes32(Fr.unwrap(t.relationParameters.etaTwo)));
        console2.log("eta_three:");
        console2.logBytes32(bytes32(Fr.unwrap(t.relationParameters.etaThree)));
        console2.log("beta:");
        console2.logBytes32(bytes32(Fr.unwrap(t.relationParameters.beta)));
        console2.log("gamma:");
        console2.logBytes32(bytes32(Fr.unwrap(t.relationParameters.gamma)));
        console2.log("rho:");
        console2.logBytes32(bytes32(Fr.unwrap(t.rho)));
        console2.log("gemini_r:");
        console2.logBytes32(bytes32(Fr.unwrap(t.geminiR)));
        console2.log("shplonk_nu:");
        console2.logBytes32(bytes32(Fr.unwrap(t.shplonkNu)));
        console2.log("shplonk_z:");
        console2.logBytes32(bytes32(Fr.unwrap(t.shplonkZ)));
        ...
        console2.log("public_inputs_delta:");
        console2.logBytes32(bytes32(Fr.unwrap(t.relationParameters.publicInputsDelta)));
    ...
    function verifySumcheck(Honk.Proof memory proof, Transcript memory tp) internal view returns (bool verified) {
        console2.log("=== Starting Sumcheck Verification ===");
        console2.log("logN:", logN);
        
        Fr roundTarget;
        Fr powPartialEvaluation = Fr.wrap(1);
        
        console2.log("initial_target:");
        console2.logBytes32(bytes32(Fr.unwrap(roundTarget)));
        console2.log("initial_pow_partial:");
        console2.logBytes32(bytes32(Fr.unwrap(powPartialEvaluation)));

        // We perform sumcheck reductions over log n rounds ( the multivariate degree )
        for (uint256 round; round < logN; ++round) {
            console2.log("=== Sumcheck Round", round, "===");
            Fr[BATCHED_RELATION_PARTIAL_LENGTH] memory roundUnivariate = proof.sumcheckUnivariates[round];
            console2.logBytes32(bytes32(Fr.unwrap(roundUnivariate[0])));
            console2.logBytes32(bytes32(Fr.unwrap(roundUnivariate[1])));
            
            bool valid = checkSum(roundUnivariate, roundTarget);
            if (!valid) revert SumcheckFailed();

            Fr roundChallenge = tp.sumCheckUChallenges[round];
            console2.logBytes32(bytes32(Fr.unwrap(roundChallenge)));
        ...
        // Last round
        console2.log("=== Final Sumcheck Round ===");
        ...
        console2.logBytes32(bytes32(Fr.unwrap(grandHonkRelationSum)));
        console2.logBytes32(bytes32(Fr.unwrap(roundTarget)));
        
        verified = (grandHonkRelationSum == roundTarget);
        console2.log("Sumcheck verification result:", verified);
    }
        ...
        returns (bool checked)
    {
        ...
        console2.logBytes32(bytes32(Fr.unwrap(totalSum)));
        console2.logBytes32(bytes32(Fr.unwrap(roundTarget)));
        checked = totalSum == roundTarget;
        console2.log("checkSum result:", checked);
    }
    ...
    {
        console2.log("=== Starting Shplemini Verification ===");
        ...
        console2.log("gemini_r:");
        console2.logBytes32(bytes32(Fr.unwrap(tp.geminiR)));
        console2.log("shplonk_nu:");
        console2.logBytes32(bytes32(Fr.unwrap(tp.shplonkNu)));
        console2.log("shplonk_z:");
        console2.logBytes32(bytes32(Fr.unwrap(tp.shplonkZ)));
        console2.log("rho:");
        console2.logBytes32(bytes32(Fr.unwrap(tp.rho)));

        // Arrays hold values that will be linearly combined for the gemini and shplonk batch openings
        Fr[NUMBER_OF_ENTITIES + CONST_PROOF_SIZE_LOG_N + 2] memory scalars;
        Honk.G1Point[NUMBER_OF_ENTITIES + CONST_PROOF_SIZE_LOG_N + 2] memory commitments;

        console2.log("=== SHPLONK VERIFICATION DETAILS ===");
        console2.log("Number of entities:");
        console2.log(NUMBER_OF_ENTITIES);
        console2.log("Number unshifted:");
        console2.log(NUMBER_UNSHIFTED);
        console2.log("Number to be shifted:");
        console2.log(NUMBER_TO_BE_SHIFTED);
        console2.log("Proof size log N:");
        console2.log(CONST_PROOF_SIZE_LOG_N);
        console2.log("Total commitments array size:");
        console2.log(NUMBER_OF_ENTITIES + CONST_PROOF_SIZE_LOG_N + 2);
        console2.log("Total scalars array size:");
        console2.log(NUMBER_OF_ENTITIES + CONST_PROOF_SIZE_LOG_N + 2);

        // Step 1: Initial setup
        console2.log("=== Step 1: Initial setup ===");
        ...
        console2.log("posInvertedDenominator:");
        console2.logBytes32(bytes32(Fr.unwrap(mem.posInvertedDenominator)));
        console2.log("negInvertedDenominator:");
        console2.logBytes32(bytes32(Fr.unwrap(mem.negInvertedDenominator)));
        console2.log("unshiftedScalar:");
        console2.logBytes32(bytes32(Fr.unwrap(mem.unshiftedScalar)));
        console2.log("shiftedScalar:");
        console2.logBytes32(bytes32(Fr.unwrap(mem.shiftedScalar)));
        ...
        // Step 3: Process unshifted elements
        console2.log("=== Step 3: Processing unshifted elements ===");
        for (uint256 i = 1; i <= NUMBER_UNSHIFTED; ++i) {
            scalars[i] = mem.unshiftedScalar.neg() * mem.batchingChallenge;
            mem.batchedEvaluation = mem.batchedEvaluation + (proof.sumcheckEvaluations[i - 1] * mem.batchingChallenge);
            mem.batchingChallenge = mem.batchingChallenge * tp.rho;
            
            if (i <= 3 || i == NUMBER_UNSHIFTED) { // Log first 3 and last element
                console2.log("Unshifted element");
                console2.log(i);
                console2.log("Scalar:");
                console2.log(Fr.unwrap(scalars[i]));
                console2.log("Sumcheck eval:");
                console2.log(Fr.unwrap(proof.sumcheckEvaluations[i - 1]));
                console2.log("Batching challenge:");
                console2.log(Fr.unwrap(mem.batchingChallenge));
            }
        }
        
        // Step 4: Process shifted elements
        console2.log("=== Step 4: Processing shifted elements ===");
        for (uint256 i = NUMBER_UNSHIFTED + 1; i <= NUMBER_OF_ENTITIES; ++i) {
            scalars[i] = mem.shiftedScalar.neg() * mem.batchingChallenge;
            mem.batchedEvaluation = mem.batchedEvaluation + (proof.sumcheckEvaluations[i - 1] * mem.batchingChallenge);
            mem.batchingChallenge = mem.batchingChallenge * tp.rho;
            
            if (i == NUMBER_UNSHIFTED + 1 || i == NUMBER_OF_ENTITIES) { // Log first and last element
                console2.log("Shifted element");
                console2.log(i);
                console2.log("Scalar:");
                console2.log(Fr.unwrap(scalars[i]));
                console2.log("Sumcheck eval:");
        ...
        console2.log("batchedEvaluation:");
        console2.logBytes32(bytes32(Fr.unwrap(mem.batchedEvaluation)));
        console2.log("batchingChallenge:");
        console2.logBytes32(bytes32(Fr.unwrap(mem.batchingChallenge)));

        // Step 5: Load verification key commitments
        console2.log("=== Step 5: Loading verification key commitments ===");
        commitments[1] = vk.qm;
        commitments[2] = vk.qc;
        commitments[3] = vk.ql;
        commitments[4] = vk.qr;
        ...
        console2.log("VK commitments loaded (indices 1-27)");

        // Step 6: Load proof points
        console2.log("=== Step 6: Loading proof points ===");
        ...
        console2.log("Proof points loaded (indices 28-35)");

        // Step 7: Load shifted proof points
        console2.log("=== Step 7: Loading shifted proof points ===");
        ...
        console2.log("Shifted proof points loaded (indices 36-40)");
        ...
        console2.log("=== Finalizing batch opening claim ===");
        console2.logBytes32(bytes32(Fr.unwrap(mem.constantTermAccumulator)));
        ...
        console2.log("=== Starting P0 and P1 calculation ===");
        console2.logBytes32(bytes32(quotient_commitment.x));
        console2.logBytes32(bytes32(quotient_commitment.y));
        
        Honk.G1Point memory P_0 = batchMul(commitments, scalars);
        console2.log("=== P0 calculated ===");
        console2.logBytes32(bytes32(P_0.x));
        console2.logBytes32(bytes32(P_0.y));
        
        Honk.G1Point memory P_1 = negateInplace(quotient_commitment);
        console2.log("=== P1 calculated (negated) ===");
        console2.logBytes32(bytes32(P_1.x));
        console2.logBytes32(bytes32(P_1.y));

        // forge-std - P0, P1座標のログ出力
        console2.log("=== P0 and P1 Coordinates (Hexadecimal) ===");
        console2.logBytes32(bytes32(P_0.x));
        console2.logBytes32(bytes32(P_0.y));
        console2.logBytes32(bytes32(P_1.x));
        console2.logBytes32(bytes32(P_1.y));
        
        console2.log("=== FINAL PAIRING VALUES ===");
        console2.log("quotient_commitment.x:");
        console2.logBytes32(bytes32(quotient_commitment.x));
        console2.log("quotient_commitment.y:");
        console2.logBytes32(bytes32(quotient_commitment.y));
        console2.log("P_0.x:");
        console2.logBytes32(bytes32(P_0.x));
        console2.log("P_0.y:");
        ...
        bool pairing_result = pairing(P_0, P_1);
        console2.log("=== ERROR ANALYSIS ===");
        console2.log("pairing_result:", pairing_result);
    ...
    function batchMul(
        ...
        console2.log("=== Starting batchMul ===");
        console2.log("Total elements to process:", limit);
        console2.log("NUMBER_OF_ENTITIES:", NUMBER_OF_ENTITIES);
        console2.log("CONST_PROOF_SIZE_LOG_N:", CONST_PROOF_SIZE_LOG_N);
        
        // Log first few elements for debugging
        console2.log("=== First few elements preview ===");
        for (uint256 i = 0; i < 100 && i < limit; i++) {
        ...
        if (limit > 100) {
            console2.log("... and");
            console2.log(limit - 100);
            console2.log("more elements");
        }
