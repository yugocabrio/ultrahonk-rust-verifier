...
- `--dataset`: Path to the directory containing `vk_fields.json`, `proof`, and `public_inputs` (Default: `../tests/fib_chain/target`).

### Example

```bash
npx ts-node measure_ultrahonk_costs.ts \
  --contract-id CAL4FBW62GLCOZ3RUHPQQGWC5ANDAMCH5SPPFIZUA24Q3LY2U2GNP4NT \
